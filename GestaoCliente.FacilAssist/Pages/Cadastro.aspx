<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Layout/Site.Master" AutoEventWireup="true" Async="true" CodeBehind="Cadastro.aspx.cs" Inherits="GestaoCliente.FacilAssist.Pages.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form>
      ...
      ValidationExpression="^[a-zA-Z ]*$"></asp:RegularExpressionValidator>
        ...
        <asp:Button ID="btnCadastrar" runat="server" Text="Cadastrar" CssClass="btn btn-primary m-3" OnClick="btnCadastrar_Click" />
    </form>
</asp:Content>
